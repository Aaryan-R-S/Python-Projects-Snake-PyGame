...
<p align="center">
  ...
  <h3 align="center">Snake PyGame</h3>
...
This is a popular Snake game built with Python PyGame module! It is mind relaxing to play it in my free time.
...
- Clone the repo
   ```sh
   git clone https://github.com/Aaryan-R-S/Python-Projects-Snake-PyGame.git
   ```
- Python Modules
  - `pip install pygame`
